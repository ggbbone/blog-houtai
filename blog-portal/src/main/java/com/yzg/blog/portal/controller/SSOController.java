...
public class SSOController {
    ...
    public CommonResult login(@Valid @RequestBody UserLoginDTO params, HttpServletRequest request) throws Exception {
    ...
    public CommonResult register(@Valid @RequestBody UserRegisterDTO params) throws Exception {
